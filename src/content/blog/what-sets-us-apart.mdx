...
For example, we're using it to build our <Link href="/blog/musicianship-building-practice-companion/" text="Musicianship-Building Practice Companion app" data-astro-prefetch />.
...
Sound good? Reach out <Link href="/#contact" text="here" data-astro-prefetch /> to get started.
