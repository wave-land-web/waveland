...
I'll go over a couple of cool examples here. If you're ready to dive in for yourself, head to the <Link href="https://github.com/wave-land-web/lsa" text="GitHub repo" newWindow={true} /> for full instructions on how to get started and you can check out the <Link href="https://lsa-lib.netlify.app/" text="demo site" newWindow={true} /> for all working examples.
