...
<Card class="lsa lsa-slide-up bg-blue text-darkBlue my-[1lh] flex items-center justify-center">
...
<Card class="lsa lsa-slide-left bg-blue text-darkBlue my-[1lh] flex items-center justify-center">
  <h3 class="!mt-0">Slide Left</h3>
</Card>
<Card class="lsa lsa-slide-right bg-blue text-darkBlue my-[1lh] flex items-center justify-center">
...
<Card class="lsa lsa-slide-up-left bg-blue text-darkBlue my-[1lh] flex items-center justify-center">
  <h3 class="!mt-0">Slide Up Left</h3>
</Card>
<Card class="lsa lsa-slide-up-right bg-blue text-darkBlue my-[1lh flex items-center justify-center">
