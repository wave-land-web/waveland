...
tags: ['ai', 'music', 'web development', 'education', 'web tech']
...
1. <Link href="https://www.vexflow.com/" text="VexFlow" newWindow={true} /> - An open-source
   JavaScript library that lets us render music notation and guitar tablature interactively on web
   pages.
2. <Link
     href="https://developer.mozilla.org/en-US/docs/Web/API/Web_Audio_API"
     text="Web Audio API"
     newWindow={true}
   /> - Gives us a ton of flexibility and control to generate and manipulate audio in all sorts of
   ways. Stoked to learn more about this.
3. <Link href="https://open.ai/" text="OpenAI API" newWindow={true} /> - I'm going start by using
   OpenAI's text generation models to generate music examples. Over time, we can fine-tune our model
   to suit various use cases. I may also want to check out some more music-specific AI models such
   as <Link href="https://magenta.tensorflow.org/" text="Magenta" newWindow={true} />
...
Do you have a fun little side project of your own that you could use some help with? Wave Land is here to assist with all of your web needs. Click <Link href="/#contact" text="here" /> to get started.import { Picture } from 'astro:assets'
import PostHeader from '../../components/blog/PostHeader.astro'
import Link from '../../components/content/Link.astro'
import headerImage from './images/musicianship-building-practice-companion.webp'
